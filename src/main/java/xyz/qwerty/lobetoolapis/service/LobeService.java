...
public interface LobeService {
	...
	LearningObjectVo assignLearningObject(String userId, Integer rubrikId, String rubrikCode, String msgSubject, String msgBody, String learningObjectName, String evaluatorEmail);
