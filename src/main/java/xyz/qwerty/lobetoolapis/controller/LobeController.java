...
public class LobeController {
	...
	public ResponseEntity<ResponseBuilder> assignRubrik(@RequestHeader(name = "Authorization") String authorization,
			@RequestParam(name = "rubrikId") Integer rubrikId, @RequestParam(name = "rubrikCode") String rubrikCode,
			@RequestParam(name = "msgSubject") String msgSubject, @RequestParam(name = "msgBody") String msgBody,
			@RequestParam(name = "learningObjectName") String learningObjectName,
			@RequestParam(name = "evaluatorEmail") String evaluatorEmail) {
	...
	public ResponseEntity<ResponseBuilder> getLobeQuestions(
			@RequestHeader(name = "Authorization") String authorization, @RequestParam(name = "code") String code) {
		...
		if (hasPermission) {
			...
			RubrikVo rubrik = lobeService.getLobeRubrik(userId, code);
	...
	public ResponseEntity<ResponseBuilder> createNewReview(@RequestHeader(name = "Authorization") String authorization, @RequestParam(name = "code") String code,
			@RequestParam(name="json") String json, @RequestParam(name = "submit") Boolean submit) {
