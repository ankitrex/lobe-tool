...
--
-- Host: localhost
-- Generation Time: Apr 25, 2019 at 03:43 PM
...
(17, b'0', 2, 'P2. Are learning objectives stated correctly?', '<a class=\"evaluate\">What does this question mean? <i class=\"fas fa-caret-right\"></i></a>\n<span class=\"hidden\">\nA learning objective should satisfy the following criteria:\nIs learner-centred\nUses measurable action verbs\nSpecifies conditions, wherever possible, under which performance is to be carried out.\nThe first two criteria are particularly important while stating learning objectives.   \n\nNote: If you feel that list of learning objectives stated does not include all the necessary ones, then P1 is the correct criteria to capture it. P2 only evaluates if the learning objectives have been stated correctly.\n</span>', 2, 'None of the learning objectives is stated correctly.', '', 'Few of the learning objectives are stated correctly ', '', 'Most of the learning objectives are stated correctly. ', '', 'All the learning objectives are stated correctly ', ''),
(18, b'0', 2, 'P3. Have the prerequisite topics been stated?', 'Note: It is sufficient to state prerequisite topics which are immediately required at one previous level to understand the content in this learning object. There is no need to go back several levels.', 2, 'No prerequisite topics, required to comprehend the current content, has been stated.', '', 'Only few of the key prerequisite topics, required for comprehending the current content, has been stated.', '', 'Most of the key prerequisite topics required to comprehend the current content, has been stated but there may be a few minor ones, which are not included.', '', 'All the key prerequisite topics required to comprehend the current content, has been stated.', ''),
